...
public class UserDietaryService {
    ...
    public UserDietaryResponse addUserDietary(String userId, AddUserDietaryRequest request) {
        ...
        return userDietaryMapper.toUserDietaryResponse(userDietaryRepo.save(userDietary));
    }
